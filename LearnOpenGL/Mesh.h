...
// TODO private
    ...
    std::vector<std::shared_ptr<Texture>> m_textures; // TODO textures kunnen door meerdere meshes worden gebruikt (waarschijnlijk zelfs), dan algemene storage maken en daarnaar pointen
